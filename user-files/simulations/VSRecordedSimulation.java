...
public class VSRecordedSimulation extends Simulation {

  {
    ...
    ScenarioBuilder scn = scenario("VSRecordedSimulation")
      .exec(
        http("request_0")
          .get("/us/")
          .headers(headers_0)
          .resources(
            ...
            http("request_22")
              ...
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0022_request.json")),
            http("request_23")
              .post(uri13 + "/contentpersonalization/v2/offers")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0023_request.json")),
            http("request_24")
            ...
            http("request_25")
              ...
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0025_request.json")),
            http("request_26")
              .post(uri13 + "/productrecommendations/v6/multi")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0026_request.json")),
            http("request_27")
              .get(uri24 + "/0/MOBILE-1.0?pe=tnt&tnta=157547%3A1%3A0%7C-1%2C161014%3A1%3A0%7C-1&mid=66537605553744314511993488921363569140&c.&a.&target.&sessionId=107d1c23-ebd7-44dd-a109-235c4416dc1e&.target&.a&.c&activeCountry=US")
              .headers(headers_18),
            http("request_28")
              .post(uri13 + "/productrecommendations/v6/multi")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0028_request.json")),
            http("request_29")
              .get(uri24 + "/0/MOBILE-1.0?pe=tnt&tnta=167792%3A0%3A0%7C2%2C157547%3A1%3A0%7C-1%2C161014%3A1%3A0%7C-1&mid=66537605553744314511993488921363569140&c.&a.&target.&sessionId=107d1c23-ebd7-44dd-a109-235c4416dc1e&.target&.a&.c&activeCountry=US")
              .headers(headers_18),
            http("request_30")
            ...
            http("request_60")
              ...
              .headers(headers_60)
              .body(RawFileBody("vsrecordedsimulation/0060_request.dat")),
            http("request_61")
            ...
            http("request_98")
              ...
              .headers(headers_98)
              .body(RawFileBody("vsrecordedsimulation/0098_request.bin")),
            http("request_99")
            ...
            http("request_119")
              ...
              .headers(headers_60)
              .body(RawFileBody("vsrecordedsimulation/0119_request.dat")),
            http("request_120")
            ...
            http("request_144")
              ...
              .headers(headers_60)
              .body(RawFileBody("vsrecordedsimulation/0144_request.dat"))
          )
      )
      .pause(14)
      .exec(
        http("request_145")
          ...
          .headers(headers_60)
          .body(RawFileBody("vsrecordedsimulation/0145_request.dat"))
          .resources(
            http("request_146")
              .post(uri13 + "/auth/v21/sign-in")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0146_request.bin")),
            http("request_147")
            ...
            http("request_168")
              .post(uri13 + "/contentpersonalization/v2/monitor")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0168_request.json")),
            http("request_169")
              .post(uri13 + "/contentpersonalization/v2/offers")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0169_request.json")),
            http("request_170")
              .get(uri24 + "/0/MOBILE-1.0?pe=tnt&tnta=156941%3A1%3A0%7C-1%2C157547%3A1%3A0%7C-1%2C160037%3A0%3A0%7C-1%2C174684%3A0%3A0%7C-1%2C161014%3A1%3A0%7C-1&mid=66537605553744314511993488921363569140&c.&a.&target.&sessionId=107d1c23-ebd7-44dd-a109-235c4416dc1e&.target&.a&.c&activeCountry=US")
              .headers(headers_18),
            http("request_171")
            ...
            http("request_175")
              .post(uri13 + "/productrecommendations/v6/multi")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0175_request.json")),
            http("request_176")
            ...
            http("request_178")
              .post(uri13 + "/productrecommendations/v6/multi")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0178_request.json")),
            http("request_179")
              .post(uri13 + "/productrecommendations/v6/multi")
              .headers(headers_22)
              .body(RawFileBody("vsrecordedsimulation/0179_request.json")),
            http("request_180")
              .get(uri24 + "/0/MOBILE-1.0?pe=tnt&tnta=156941%3A1%3A0%7C-1%2C157547%3A1%3A0%7C-1%2C160037%3A0%3A0%7C-1%2C174684%3A0%3A0%7C-1%2C161014%3A1%3A0%7C-1&mid=66537605553744314511993488921363569140&c.&a.&target.&sessionId=107d1c23-ebd7-44dd-a109-235c4416dc1e&.target&.a&.c&activeCountry=US")
              .headers(headers_18),
            http("request_181")
            ...
            http("request_210")
              ...
              .headers(headers_60)
              .body(RawFileBody("vsrecordedsimulation/0210_request.dat")),
            http("request_211")
              .get(uri09 + "/?ad_log=referer&action=lead&pixid=69b7d2da-f552-4f04-9184-33c368e8f5a3")
              .headers(headers_86),
            http("request_212")
            ...
            http("request_244")
              ...
              .headers(headers_98)
              .body(RawFileBody("vsrecordedsimulation/0244_request.bin")),
            http("request_245")
